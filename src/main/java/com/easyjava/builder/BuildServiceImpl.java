...
public class BuildServiceImpl {
    ...
    public static void execute(TableInfo tableInfo) {
        ...
        try (OutputStream out = new FileOutputStream(
            ...
            bw.newLine();
            bw.write("public class " + tableInfo.getBeanName() + "ServiceImpl implements " + tableInfo.getBeanName()
                    + "Service{");
            bw.newLine();
            bw.newLine();
            ...
            bw.newLine();
            bw.write(
                    "\tpublic List<" + tableInfo.getBeanName() + "> FindListParam(" + tableInfo.getBeanParamName()
                            + " param) {");
            bw.newLine();
            ...
            bw.write("\t\tPaginationResultVO<" + tableInfo.getBeanName()
                    + "> result = new PaginationResultVO<>(count, page.getPageSize(), page.getPageNo(),\r\n" + //
            ...
            for (Map.Entry<String, List<FieldInfo>> entry : tableInfo.getKeyIndexMap().entrySet()) {
                ...
                bw.newLine();
                bw.write("\t\treturn this." + mapperBeanName + ".SelectBy" + methodName + "(" + queryParam + ");");
                bw.write("\t}");
                ...
                bw.write("\t@Override");
                bw.newLine();
                bw.write("\tpublic Integer UpdateBy" + methodName + "(" + tableInfo.getBeanName() + " bean, "
                        + methodParam + ") {");
                bw.newLine();
                ...
                bw.newLine();
                bw.write("\t\treturn this." + mapperBeanName + ".DeleteBy" + methodName + "(" + queryParam + ");");
                bw.newLine();
                bw.write("\t}");
